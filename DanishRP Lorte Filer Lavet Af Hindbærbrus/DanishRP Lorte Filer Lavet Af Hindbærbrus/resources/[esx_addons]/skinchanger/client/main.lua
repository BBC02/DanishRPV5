local Components = {
	{label = _U('new_skin'),				name = 'new_skin',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('sex'),						name = 'sex',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65, changeBlock = true},
	...
	-- New face
	{label = _U('mom'),						name = 'mom',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	...
	-- New default value, and extra features i guess
...
function GetMaxVals()
	...
	local data = {
		...
		-- New Face (Full support for mixing male faces and female faces, creating more possibilitys more uniqueness)
		mom				= 45, -- numbers 21-41 and 45 are female (22 total)
		dad				= 45, -- numbers 0-20 and 42-44 are male (24 total)
		face_md_weight	= 100,
		skin_md_weight	= 100,
		nose_1			= 10,
		nose_2			= 10,
		...
		arms_2			= GetNumberOfPedTextureVariations		(playerPed, 3, Character['arms']) - 1,
...
function ApplySkin(skin, clothes)
	...
	if Character['new_skin'] then
		if Character['new_skin'] == 1 then
			newSkin = true
		end
	end
