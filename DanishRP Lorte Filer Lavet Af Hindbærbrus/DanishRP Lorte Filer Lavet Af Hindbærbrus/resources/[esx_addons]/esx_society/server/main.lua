...
local DISCORD_WEBHOOK = "https://discord.com/api/webhooks/1047605700836212836/QwMj1yhzS88eTqgutKblRiVx33Ix3SLTphbM6yVrhZMO8vUdPNOQ6Gyo38iopx8ZDS9v"
...
ESX.RegisterServerCallback('esx_society:setJob', function(source, cb, identifier, job, grade, type, oldjob)
	local xPlayer = ESX.GetPlayerFromId(source)
	...
	if isBoss then
		...
		if xTarget then
			...
			elseif type == 'fire' then
				TriggerEvent("core_multijob:fireJob",xTarget.getIdentifier(), oldjob)
