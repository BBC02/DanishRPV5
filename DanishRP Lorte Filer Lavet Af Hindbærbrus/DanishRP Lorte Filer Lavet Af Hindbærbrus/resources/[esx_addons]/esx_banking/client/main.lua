    ...
    for _, id in pairs(ids) do
        if not Peds[id] then
            ...
            if Config.Target then
                exports.qtarget:AddTargetModel({-1022961931}, {
                    options = {
                        {
                            event = "esx_banking:openbankui",
...
RegisterNetEvent('esx_banking:openatmui', function()
    OpenUi()
end)

RegisterNetEvent('esx_banking:openbankui', function()
    OpenUi()
end)
...
local function StartThread()
    CreateThread(function()
        ...
        if Config.Target then
            ...
            --     distance = 1.5
            -- })
            exports.qtarget:AddTargetModel({`prop_fleeca_atm`, `prop_atm_01`, `prop_atm_02`, `prop_atm_03`}, {
                options = {
                    {
                        event = "esx_banking:openatmui",
                        icon = "fas fa-credit-card",
