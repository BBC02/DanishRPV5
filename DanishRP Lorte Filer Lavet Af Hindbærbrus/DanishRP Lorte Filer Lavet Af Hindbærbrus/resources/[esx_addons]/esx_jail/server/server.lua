...
RegisterServerEvent("esx2-qalle-jail:jailPlayer", function(targetSrc, jailTime, jailReason, src)
    local src = source
...
RegisterServerEvent("esx-qalle-jail:unJailPlayer", function(targetIdentifier)
	local src = source
...
RegisterServerEvent("esx-qalle-jail:updateJailTime", function(newJailTime)
	local src = source

	EditJailTime(src, newJailTime)
end)

RegisterServerEvent("esx-qalle-jail:server:prisonWorkReward", function()
	local src = source
	local xPlayer = ESX.GetPlayerFromId(src)

	TriggerClientEvent("esx-qalle-jail:client:prisonWorkReward", src)
