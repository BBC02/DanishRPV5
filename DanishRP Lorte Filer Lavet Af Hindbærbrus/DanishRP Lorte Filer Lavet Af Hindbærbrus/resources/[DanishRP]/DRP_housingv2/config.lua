Config = {
  ...
  WaitToRender = false,    -- might help reduce MS when you have lots of houses
  ...
  Notify = {
    Ugyldig = 'Ugyldigt beløb',
    Nummer = 'Du skal skrive et tal.',
    UgyldigMaengde = 'Ugyldigt mængde',
  },

  Menu = {
    Title = 'Bolig Inventar',
    InsertItems = '<b>Læg ting i</b>',
    Penge = '―― Kontanter ――',
    Items = '―― Ting ――',
    WeaponKategori = '―― Våben ――',
    WeaponInventoryKategori = '―― Våben etc. ――',
    DitInventory = 'Dit inventar',
    Maengde = 'Beløb', 
    Antal = 'Antal',
  },
  ...
  CreationJobs = {
    ...
    --   minRank = 0,                    -- min rank to create house.
    --   society = true,                 -- use society accounts?
    --   account = 'society_sjbolig', -- society account name
    --   payCut  = 10,                   -- % of sale earnt by player, rest goes to realestate society account (if using esx_society, else goes nowhere).
    -- },
  },
