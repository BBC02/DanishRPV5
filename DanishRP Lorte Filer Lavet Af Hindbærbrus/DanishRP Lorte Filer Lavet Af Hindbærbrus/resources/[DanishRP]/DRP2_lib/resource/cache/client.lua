...
function cache:getSelectedWeapon()
	local selectedWeapon = GetSelectedPedWeapon(self.ped)
	if lib.cache('selectedWeapon') ~= selectedWeapon then
		self:set('selectedWeapon', selectedWeapon)
	end
end
