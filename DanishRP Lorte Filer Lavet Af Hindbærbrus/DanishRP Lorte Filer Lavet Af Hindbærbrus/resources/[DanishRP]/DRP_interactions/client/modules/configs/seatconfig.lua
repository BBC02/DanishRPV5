...
Config.Sitable = {
	-- BENCH
	[`prop_bench_01a`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_01b`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_01c`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_02`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_03`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_04`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_05`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_06`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_08`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_09`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	
	[`prop_bench_10`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_bench_11`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_fib_3b_bench`] 				= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_ld_bench01`] 				= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_wait_bench_01`] 				= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	[`prop_wait_bench_01`] 				= { scenario = 'PROP_HUMAN_SEAT_BENCH', divider = 2.7},
	--prop_chair_04a
	...
	[`prop_chair_04c`] 					= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
	...
	-- OLD ESX_SIT
	[`apa_mp_h_stn_chairarm_11`]    	= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = -0.2, leftOffset = 0.1},
	[`v_ret_chair`] 			    	= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
	[`v_ret_chair_white`] 				= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.55, forwardOffset = 0.0, leftOffset = 0.0},
	[`ba_prop_battle_club_chair_01`]	= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.05, leftOffset = 0.05},
	[`ba_prop_battle_club_chair_02`]	= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.05, leftOffset = 0.05},
	[`ex_prop_offchair_exec_04`]    	= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.05, leftOffset = 0.05},

	[`v_res_m_dinechair`]    			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.05, leftOffset = 0.05},

	[444105316]    						= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.05, leftOffset = 0.05},
	[-425962029]    					= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.05, leftOffset = 0.05},
}

for k, _ in pairs(Config.Sitable) do
	Config.SitableProps[#Config.SitableProps + 1] = k
end
