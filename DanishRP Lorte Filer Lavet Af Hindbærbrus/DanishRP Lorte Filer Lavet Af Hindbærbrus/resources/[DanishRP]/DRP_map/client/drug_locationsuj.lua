local methlab = GetInteriorAtCoordsWithType(598.24040,-423.3888,17.620,"int_stock")
local cokelab = GetInteriorAtCoordsWithType(-1974.080,-228.9903,27.864,"int_stock")
local weedlab = GetInteriorAtCoordsWithType(2862.444,4456.0014,41.322,"int_stock")
local opiumlab = GetInteriorAtCoordsWithType(2536.508,4118.2700,31.460,"int_stock")

RefreshInterior(methlab)
EnableInteriorProp(methlab, "meth_staff_01")
EnableInteriorProp(methlab, "meth_staff_02")
EnableInteriorProp(methlab, "meth_basic_lab_01")
EnableInteriorProp(methlab, "meth_basic_lab_02")
EnableInteriorProp(methlab, "meth_basic_lab_01_2")
EnableInteriorProp(methlab, "meth_basic_lab_02_2")
EnableInteriorProp(methlab, "meth_stock")

RefreshInterior(weedlab)
EnableInteriorProp(weedlab, "weed_app")
EnableInteriorProp(weedlab, "weed_staff_01")
EnableInteriorProp(weedlab, "weed_staff_02")
--EnableInteriorProp(weedlab, "weed_basic_lamp")
--EnableInteriorProp(weedlab, "weed_fan_basick")
EnableInteriorProp(weedlab, "weed_plant_v2")
EnableInteriorProp(weedlab, "weed_stock")

RefreshInterior(cokelab)
EnableInteriorProp(cokelab, "coke_app")
EnableInteriorProp(cokelab, "coke_staff_01")
EnableInteriorProp(cokelab, "coke_staff_02")
EnableInteriorProp(cokelab, "coke_stock")

RefreshInterior(opiumlab)
EnableInteriorProp(opiumlab, "coke_app")
EnableInteriorProp(opiumlab, "coke_staff_01")
EnableInteriorProp(opiumlab, "coke_staff_02")
EnableInteriorProp(opiumlab, "coke_stock")
