...
CreateThread(function()
    ...
    -- Sync Config Data:
    RegisterNetEvent('savanha:SyncDataCL')
    AddEventHandler('savanha:SyncDataCL',function(data)
    ...
    RegisterNetEvent('savanha:startJobCL')
    AddEventHandler('savanha:startJobCL',function()
        ...
        if takenNum == 100 then
            ...
            TriggerEvent('savanha:truckRobberyJob',num)
