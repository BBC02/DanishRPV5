(function(t) {
    function e(e) {
        for(var n, s, i=e[0], c=e[1], u=e[2], h=0, f=[]; h<i.length; h++)s=i[h], Object.prototype.hasOwnProperty.call(a, s)&&a[s]&&f.push(a[s][0]), a[s]=0; for(n in c)Object.prototype.hasOwnProperty.call(c, n)&&(t[n]=c[n]); l&&l(e); while(f.length)f.shift()(); return r.push.apply(r, u||[]), o()
    }
    ...
    , r=[]; function s(e) {
        if(n[e])return n[e].exports; var o=n[e]= {
            i:e, l: !1, exports: {}
        }
...
, s.t=function(t, e) {
if(1&e&&(t=s(t)), 8&e)return t; if(4&e&&"object"===typeof t&&t&&t.__esModule)return t; var o=Object.create(null); if(s.r(o), Object.defineProperty(o, "default", {
        enumerable: !0, value:t

    }), 2&e&&"string" !=typeof t)for(var n in t)s.d(o, n, function(e) {
    return t[e]
}
...
, s.p=""; var i=window["webpackJsonp"]=window["webpackJsonp"]||[], c=i.push.bind(i); i.push=e, i=i.slice(); for(var u=0; u<i.length; u++)e(i[u]); var l=c; r.push([0, "chunk-vendors"]), o()
...
, "56d7":function(t, e, o) {
    "use strict"; o.r(e); o("e260"), o("e6cf"), o("cca6"), o("a79d"); var n=o("2b0e"), a=function() {
        var t=this, e=t.$createElement, o=t._self._c||e; return t.opened?o("div", {
            attrs: {
                id:"App"
            }
        }
...
class:"body"===t.selectedMenu?"clothing-button active":"clothing-button", on: {
    click:function(e) {
        t.selectedMenu="body"
    }
}
...
class:"clothing"===t.selectedMenu?"clothing-button active":"clothing-button", on: {
    click:function(e) {
...
class:"accessories"===t.selectedMenu?"clothing-button active":"clothing-button", on: {
    click:function(e) {
...
class:"wardrobe"===t.selectedMenu?"clothing-button active":"clothing-button", on: {
    click:function(e) {
...
, [o("CameraMenu", {
attrs: {
    NameResource:t.NameResource, isTattoShop:t.isTattoShop, selectedMenu:t.selectedMenu, close:t.close
}

}), t.isClothing()?o("ModuleMenu", {
attrs: {
    Components:t.Components, NameResource:t.NameResource, selectedMenu:t.selectedMenu, selectedStore:t.selectedStore, close:t.close
}

}):t._e(), "wardrobe"===t.selectedMenu?o("WardrobeMenu", {
attrs: {
    NameResource:t.NameResource, Wardrobe:t.Wardrobe, selectedMenu:t.selectedMenu, close:t.close
}
...
attrs: {
    Tattos:t.Tattos, PlayerJob:t.PlayerJob, PlayerIdentifier:t.PlayerIdentifier, NameResource:t.NameResource, close:t.close
}
})], 1):t._e()])])]):t._e()
}

, r=[function() {
var t=this, e=t.$createElement, o=t._self._c||e; return o("div", {
...
], s=(o("b0c0"), o("bc3a")), i=o.n(s), c=o("3d20"), u=o.n(c), l=function() {
var t=this, e=t.$createElement, o=t._self._c||e; return o("div", {
    staticClass:"camera-menu"
}

, [t.isTattoShop?t._e():o("button", {
    staticClass:"camera-button", on: {
        click:function(e) {
...
, methods: {
    SetCamera:function(t) {
        var e=this.NameResource[0]; i.a.post("https://" .concat(e, "/SetCamera"), {
            type:t, isTattoShop:this.isTattoShop
...
, ToggleClothing:function(t) {
    var e=this.NameResource[0]; i.a.post("https://" .concat(e, "/ToggleClothing"), {
        type:t
...
, Handsup:function() {
var t=this.NameResource[0]; i.a.post("https://" .concat(t, "/Handsup")).catch((function(t) {
...
, d=f, m=(o("f30d"), o("2877")), v=Object(m["a"])(d, l, h, !1, null, null, null), p=v.exports, b=function() {
var t=this, e=t.$createElement, o=t._self._c||e; return o("div", {
...
, t._l(t.SortedSkinList, (function(e, n) {
            return o("div", {
                key:n, class:n===t.SortedSkinList.length-1?"element end":"element"
            }
    ...
    directives:[ {
        name:"model", rawName:"v-model", value:e.value, expression:"item.value"
    }
...
directives:[ {
    name:"model", rawName:"v-model", value:e.texturevalue, expression:"item.texturevalue"
}
...
, methods: {
    ...
    , addItemValue:function(t, e) {
        if(0==e) {
            if(t.max<=t.value)return; t.value++, this.hasItemTextures(t)&&(t.texturevalue=0, this.SetClothingItem(t.texturename, t.texturevalue)), this.SetClothingItem(t.name, t.value)
        }

        if(1==e) {
            if(t.texturemax<=t.texturevalue)return; t.texturevalue++, this.SetClothingItem(t.texturename, t.texturevalue)
        }
    }

    , removeItemValue:function(t, e) {
        if(0==e) {
            if(t.min>=t.value)return; t.value--, this.hasItemTextures(t)&&(t.texturevalue=0, this.SetClothingItem(t.texturename, t.texturevalue)), this.SetClothingItem(t.name, t.value)
        }

        if(1==e) {
            if(t.texturemin>=t.texturevalue)return; t.texturevalue--, this.SetClothingItem(t.texturename, t.texturevalue)
        }
    }

    , SetClothingItem:function(t, e) {
        var o=this.NameResource[0]; i.a.post("https://" .concat(o, "/SetClothing"), {
            name:t, value:e
...
SortedSkinList:function() {
    var t=[]; for(var e in this.Components) {
        var o=this.Components[e]; if(o.category===this.selectedMenu) {
            if("" !==this.selectedStore&&o.store !==this.selectedStore)continue; t.push(o)
        }
    }
...
, T=C, x=(o("4b79"), Object(m["a"])(T, b, g, !1, null, null, null)), S=x.exports, y=function() {
var t=this, e=t.$createElement, o=t._self._c||e; return o("div", {
...
, [t._v("Reset Outfit")])])]), t._l(t.sortedWardrobe, (function(e, n) {
        return o("div", {
            key:e.index, class:n===t.Wardrobe.length-1?"wardrobe-element end":"wardrobe-element"
        }
...
, methods: {
    SaveOutfit:function() {
        var t=this; Object(R["a"])(regeneratorRuntime.mark((function e() {
                        var o, n, a, r; return regeneratorRuntime.wrap((function(e) {
                                    while(1)switch(e.prev=e.next) {
                                        case 0:return e.next=2, u.a.fire({
                                            title:"Navn på dit Outfit", input:"text", inputPlaceholder:"Skriv navnet på dit Outfit her...", showCancelButton: !0

                                        }); case 2:o=e.sent, n=o.value, n&&(a=n, r=t.NameResource[0], i.a.post("https://" .concat(r, "/SaveOutfit"), {
                                            outfit_name:a
...
var t=this.NameResource[0]; i.a.post("https://" .concat(t, "/ResetOutfit")).catch((function(t) {
            console.log(t+" : Error at ResetOutfit")
        }))
}

, ChooseOutfit:function(t) {
var e=t.index, o=this.NameResource[0]; i.a.post("https://" .concat(o, "/ChooseOutfit"), {
    index:e
...
var e=this, o=t.index; u.a.fire({
    title:"Er du sikker på at overskrive dette outfit?", showDenyButton: !1, showCancelButton: !0, confirmButtonText:"Ja", cancelButtonText:"Nej"

}).then((function(t) {
        if(t.isConfirmed) {
            var n=e.NameResource[0]; i.a.post("https://" .concat(n, "/OverrideOutfit"), {
                index:o
...
var e=this, o=t.index; u.a.fire({
    title:"Er du sikker på at slette dette outfit?", showDenyButton: !1, showCancelButton: !0, confirmButtonText:"Ja", cancelButtonText:"Nej"

}).then((function(t) {
        if(t.isConfirmed) {
            var n=e.NameResource[0]; i.a.post("https://" .concat(n, "/DeleteOutfit"), {
                index:o
...
sortedWardrobe:function() {
    var t=[]; for(var e in this.Wardrobe) {
        var o=this.Wardrobe[e]; t.push({
            index:e, label:o.label
        })
}

return t.sort((function(t, e) {
            return t.label>e.label?1:-1
        }))
}
}

}), I=k, w=(o("1b78"), Object(m["a"])(I, y, _, !1, null, null, null)), M=w.exports, O=function() {
var t=this, e=t.$createElement, o=t._self._c||e; return o("div", {
...
, [t._l(t.SortedTattoList, (function(e, n) {
            return o("div", {
                key:n, class:n===t.SortedTattoList.length-1?"tatto-element end":"tatto-element"
            }
...
directives:[ {
    name:"model", rawName:"v-model", value:e.current, expression:"item.current"
}
...
, methods: {
    ...
    , SetTattoItem:function(t) {
        var e=this.NameResource[0]; i.a.post("https://" .concat(e, "/SetTatto"), {
            item:t
...
, hasAcquiredNumber:function(t) {
    for(var e in t.acquired) {
        var o=t.acquired[e]; if(t.current===o)return !0
    }
...
, RemoveTatto:function(t) {
    var e=this.NameResource[0]; i.a.post("https://" .concat(e, "/RemoveTatto"), {
        item:t
...
, AddTatto:function(t) {
var e=this.NameResource[0]; i.a.post("https://" .concat(e, "/AddTatto"), {
    item:t
...
var t=this; u.a.fire({
    title:"Vil reset alle Tattoveringer?", showDenyButton: !1, showCancelButton: !0, confirmButtonText:"Ja", cancelButtonText:"Annullere"

}).then((function(e) {
        if(e.isConfirmed) {
            var o=t.NameResource[0]; i.a.post("https://" .concat(o, "/ResetAllTattos")).catch((function(t) {
...
SortedTattoList:function() {
    var t=[]; for(var e in this.Tattos) {
        var o=this.Tattos[e], n= !0; if(void 0 !==o.requiredJobs&&o.requiredJobs.length>0) {
            n= !1; for(var a=0; a<o.requiredJobs.length; a++) {
                var r=o.requiredJobs[a]; r===this.PlayerJob&&(n= !0)
            }
        }

        var s= !0; if(void 0 !==o.whitelistedPlayers&&o.whitelistedPlayers.length>0) {
            s= !1; for(var i=0; i<o.whitelistedPlayers.length; i++) {
                var c=o.whitelistedPlayers[i]; c===this.PlayerIdentifier&&(s= !0)
            }
        }
...
, E=P, W=(o("6dce"), Object(m["a"])(E, O, N, !1, null, null, null)), j=W.exports, J= {
components: {
    CameraMenu:p, ModuleMenu:S, WardrobeMenu:M, TattoModuleMenu:j
}

, data:function() {
    return {
        opened: !1, isFreeroaming: !1, hasWardrobe: !1, isTattoShop: !1, selectedMenu:"", selectedStore:"", Components:[], Wardrobe:[], Tattos:[], PlayerJob:"none", PlayerIdentifier:"none", NameResource:"drp_clothing"
    }
}
...
, methods: {
    ...
    , FindItem:function(t) {
        for(var e in this.Components) {
            var o=this.Components[e]; if(o.name==t)return o
        }
    ...
    , hasStoreItems:function(t) {
        var e=[]; for(var o in this.Components) {
            var n=this.Components[o]; if(t===n.category) {
                if("" !==this.selectedStore&&n.store !==this.selectedStore)continue; e.push(n)
            }
        }
    ...
    , setStarterItem:function() {
        for(var t in this.Components) {
            var e=this.Components[t]; if(this.hasStoreItems(e.category))return void(this.selectedMenu=e.category)
        }
    }

    , updateTextureMax:function(t, e) {
        var o=this.FindItem(t); null !=o&&void 0 !=o.texturemax&&(o.texturemax=e)
    }

    , RotateCamera:function(t) {
        var e=this.NameResource[0]; i.a.post("https://" .concat(e, "/RotateCamera"), {
            direction:t
...
, ToggleFreeRoam:function(t) {
    this.isFreeroaming=t; var e=this.NameResource[0]; i.a.post("https://" .concat(e, "/ToggleFreeRoam"), {
...
, close:function() {
var t=this; if( !this.closed&&(this.isTattoShop||u.a.fire({
            title:"Vil gemme dit tøj?", showDenyButton: !0, showCancelButton: !0, confirmButtonText:"Ja", cancelButtonText:"Annullere", denyButtonText:"Nej"

        }).then((function(e) {
                if(e.isConfirmed) {
                    var o=t.NameResource[0]; i.a.post("https://" .concat(o, "/saveClose")).catch((function(t) {
                                console.log(t+" : Error at saveClose")
                            })), t.selectedStore="", t.opened= !1, t.hasWardrobe= !1
                }

                if(e.isDenied) {
                    var n=t.NameResource[0]; i.a.post("https://" .concat(n, "/nosaveClose")).catch((function(t) {
                                console.log(t+" : Error at nosaveClose")
                            })), t.selectedStore="", t.opened= !1, t.hasWardrobe= !1
                }

            })), this.isTattoShop)) {
var e=this.NameResource[0]; i.a.post("https://" .concat(e, "/closeTattoShop")).catch((function(t) {
...
, keyPress:function(t) {
var e=t.key; "Escape"==e&&this.close()
}
}
...
, B=J, V=(o("034f"), Object(m["a"])(B, a, r, !1, null, null, null)), A=V.exports, F=o("f9d5"), L=o.n(F); n["a"].config.productionTip= !1, n["a"].use(L.a), new n["a"]({
render:function(t) {
    return t(A)
}
}).$mount("#app")
