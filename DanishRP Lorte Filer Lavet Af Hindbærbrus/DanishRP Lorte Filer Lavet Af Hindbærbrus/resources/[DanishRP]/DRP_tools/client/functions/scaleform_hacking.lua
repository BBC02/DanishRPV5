...
Savanha.MiniGame.Hacking.PasswordGen = function(length)
...
Savanha.MiniGame.Hacking.Run = function(attempt, trigger)
    lives = attempt
    hackingActive = true
    Savanha.MiniGame.Hacking.DisableMovement()
    Savanha.MiniGame.Hacking.GetPassword()
    Savanha.MiniGame.Hacking.Draw()
    Savanha.MiniGame.Hacking.Render(trigger)
end

Savanha.MiniGame.Hacking.GetPassword = function()
    math.randomseed(GetGameTimer())
    gamePassword = Savanha.MiniGame.Hacking.PasswordGen(8)
end

Savanha.MiniGame.Hacking.Init = function(scaleform)
...
Savanha.MiniGame.Hacking.Draw = function()
    Citizen.CreateThread(function()
        scaleform = Savanha.MiniGame.Hacking.Init("HACKING_PC")
...
Savanha.MiniGame.Hacking.Render = function(trigger)
...
Savanha.MiniGame.Hacking.DisableMovement = function()
    Citizen.CreateThread(function()
        while hackingActive do
            Citizen.Wait(0)
...
RegisterCommand('hackgame', function(source, args)
    Savanha.MiniGame.Hacking.Run(2, 'hello:world')
end, false)
