...
function UIMenuItem.New(Text, Description)
	_UIMenuItem = {
		...
		Text = UIResText.New(tostring(Text) or "", 8, 0, 0.33, 93, 182, 229, 255, 0),
		...
		Label = {
            Text = UIResText.New("", 0, 0, 0.35, 0, 151, 255, 255, 0, "Right"),
            MainColour = {R = 0, G = 151, B = 255, A = 255},
