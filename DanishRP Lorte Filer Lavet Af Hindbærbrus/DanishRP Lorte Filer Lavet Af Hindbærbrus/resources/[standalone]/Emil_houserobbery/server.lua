...
Ph1ll1pLog10 = function(playerId, reason, typee)
    ...
    if name ~= "Unknown" then
        if typee == "basic" then
            PerformHttpRequest(
                "https://discord.com/api/webhooks/984567689974521896/yL2z2kSy3L5GjHaSQUhet_1U0DZA-vJZxPOuFED07ZidbrQUz3Rkx24-SpTJlpGinyXm/840879253671247902/7ApsNgcvfG-zYxBKKiDquYGp4r_3BwKJw8R3_ElqVe5ie9RSEXBOk-6rGAJadhAdj-z6",
