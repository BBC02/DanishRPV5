...
Config.MinimumPolice = 0 -- Minimum politi for at kunne røve huse.

Config.interactSystem = 'qtarget' -- Læs herunder.
--[[
    Her kan du vælge imellem:
    fivem-target eller qtarget
]]

Config.RobbableItems = {
    [1] = {chance = 2, id = 'phone', name = 'Telefon', quantity = 1}, 
    [2] = {chance = 7, id = 'WEAPON_DAGGER', name = 'Dolk', isWeapon = true}, 
    [3] = {chance = 7, id = 'WEAPON_BAT', name = 'Bat', isWeapon = true}, 
    [4] = {chance = 7, id = 'WEAPON_KNUCKLE', name = 'Knojern', isWeapon = true}, 
    [5] = {chance = 1, id = 'bread', name = 'Brød', quantity = math.random(1, 6)}, 
    [6] = {chance = 1, id = 'water', name = 'Vand', quantity = math.random(1, 6)}, 
    [8] = {chance = 4, id = 'lockpick', name = 'Lockpick', quantity = math.random(1, 6)},
    [9] = {chance = 7, id = 'coke_pooch', name = 'Kokain', quantity = math.random(1, 6)},
    [10] = {chance = 2, id = 'radio', name = 'Radio', quantity = 1},
    [12] = {chance = 7, id = 'grip', name = 'Grip', quantity = 1}, 
    [13] = {chance = 10, id = 'goldbar', name = 'Guld bar', quantity = 1},
    [14] = {chance = 6, id = 'bulletproofvest', name = 'Skudsikkervest (100%)', quantity = 1},
    [15] = {chance = 7, id = 'herion_pooch', name = 'Herion Kanyle', quantity = 1}, 
    [16] = {chance = 10, id = 'goldnecklace', name = 'Guld Halskæde', quantity = 1}, 
    [17] = {chance = 7, id = 'painting_1', name = 'Maleri #1', quantity = 1}, 
    [18] = {chance = 7, id = 'painting_2', name = 'Maleri #2', quantity = 1}, 
    [19] = {chance = 7, id = 'painting_3', name = 'Maleri #3', quantity = 1}, 
    [20] = {chance = 7, id = 'painting_4', name = 'Maleri #4', quantity = 1}, 
}
...
Lang = {
    -- Notifys
    ['lockpick_destroyed'] = 'Du ødelagde din lockpick!',
    ['lockpick_success'] = 'Du kom igennem!',
    ['cant_rob_house'] = 'Du kan ikke røve huset..',
    ['no_lockpicks'] = 'Du har ikke en lockpick på dig',
    ['no_police'] = 'Der er ikke nok politi på arbejde.',

    -- Progressbars
    ['searching_after'] = 'Leder i %s',

    -- Qtarget, fivem-target
    ['text_to_qtarget'] = 'Røv Hus',
    ['title_to_fivemtarget'] = 'Husrøveri'
}