...
RegisterCommand('+radiotalk', function()
	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			Handle = CreateObject("prop_cs_hand_radio", 0.0, 0.0, 0.0, true, true, false)
			AttachEntityToEntity(Handle, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), 18905), 0.13555, 0.04555, -0.0120, 130.0, -38.0, 170.0, true, true, false, true, 1, true)
...
RegisterCommand('-radiotalk', function()
		...
		StopAnimTask(PlayerPedId(), "random@arrests", "generic_radio_enter", 1.0)
		DeleteEntity(Handle)
