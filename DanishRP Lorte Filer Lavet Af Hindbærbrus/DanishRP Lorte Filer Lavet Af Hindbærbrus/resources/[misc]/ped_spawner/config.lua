...
Config.PedList = {
	...
	{
		model = "u_m_m_aldinapoli", -- BLACKMARKET
		coords = vector3(1501.1747, -2124.7458, 76.0378), 
		heading = 228.2128,
		gender = "male",
	    isRendered = false,
        ped = nil,
	...
	{
		model = "s_m_m_doctor_01", -- HOSPITALS MAND - FLEMMING
		coords = vector3(308.3547, -595.5411, 43.2840),
		heading = 69.5407,
		gender = "male",
	    isRendered = false,
        ped = nil,
	...
	{
		model = "s_m_m_bouncer_01", -- HOSPITALS MAND - FLEMMING
		coords = vector3(-464.8510, -2275.9097, 8.5158),
		heading = 97.1190,
		gender = "male",
	    isRendered = false,
        ped = nil,
	...
	{
		model = "a_f_y_femaleagent", -- JOBCENTER PED
		coords = vector3(-542.5012, -197.1458, 38.2393),
		heading = 90.0932,
		gender = "male",
	    isRendered = false,
        ped = nil,
	...
	{
		model = "a_m_m_malibu_01", -- JULEMAND
		coords = vector3(190.0330, -863.0529, 31.4034),
		heading = 12.5785,
		gender = "male",
	    isRendered = false,
        ped = nil,
	...
	{
		model = "s_m_m_linecook", -- dykker shop man
		coords = vector3(-1710.2759, -1110.9465, 13.1523),
		heading = 105.0879,
		gender = "male",
	    isRendered = false,
        ped = nil,
	...
	{
		model = "a_m_y_stbla_02", -- diving mand
		coords = vector3(-544.5977, -217.6336, 37.6498),
		heading = 309.8954,
		gender = "male",
	    isRendered = false,
        ped = nil,
