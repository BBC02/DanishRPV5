...
Config = {
	...
	Lock = {
		...
		Chance			= 60,						-- % chance to enter moving vehicles
		ChanceParked	= 80,						-- % chance to enter parked vehicles (vehicles without drivers) 
	},
	...
	Engine = {
		Key				= 246,          		    -- key to toggle engine on/off (DEFAULT: [K]), set to 0 to disable.
    ...
    Search = {
        Command         = '',                 	-- command to search stolen NPC cars, set to '' to disable.
...
Config.AlarmShop = {
    ...
    bank = true,                            -- pay in bank money, false is normal cash
    price = 3,                             -- prices is based on % of vehicle price, where 10 means 10% of vehicle price
