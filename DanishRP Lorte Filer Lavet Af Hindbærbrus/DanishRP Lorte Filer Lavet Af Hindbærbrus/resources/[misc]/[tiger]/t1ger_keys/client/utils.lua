	...
	if Config.Police.EnableAlerts then
		...
		if vehicle ~= nil and DoesEntityExist(vehicle) then
			...
			if message == 'steal' then 
				TriggerServerEvent("omik_callist:addTable", nil, "Person stjæler et køretøj ved ".. street_name .. " Model ".. make .. " Nummerplade ".. plate .. " Farver "..Config.VehicleColors[color1].. Config.VehicleColors[color2], "police", coords.x, coords.y, coords.z)
			...
			elseif message == 'lockpick' then 
				...
				TriggerServerEvent("omik_callist:addTable", nil, "Person dirker et køretøj op ved ".. street_name .. " Model ".. make .. " Nummerplade ".. plate .. " Farver "..Config.VehicleColors[color1].. Config.VehicleColors[color2], "police", coords.x, coords.y, coords.z)
			end
		end
		-- send notification
