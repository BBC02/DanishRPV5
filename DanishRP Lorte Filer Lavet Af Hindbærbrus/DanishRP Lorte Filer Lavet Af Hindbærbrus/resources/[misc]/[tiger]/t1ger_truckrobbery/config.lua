...
Config.TruckRobbery = {
	...
	cooldown = 560,						-- set cooldown time in minutes, before a player can start a job again
	...
	computer = {  -- job settings (where u start the job)
		...
		fees = {amount = 5000, bankMoney = true},		-- fees amount and use bankMoney or not?
		anim = {dict = 'mp_fbi_heist', lib = 'loop'}	-- anim for computer interaction
	},

	truckBlip = {sprite = 477, color = 5, display = 2, scale = 0.60, label = 'Pengetransporter'},	-- blip for the spawned truck entity

	rob = {
		detonateTimer = 180, 					-- time until bomb is detonated
		takeLootTimer = 180, 					-- time spent to loot the truck
	...
	reward = {
		money = {dirty = true, min = 800000, max = 1800000}, -- dirty money or cash, min amunt and max amount of cash.
		items = {
			enable = false,			-- enable/disable item rewards
			list = {
...
Config.TruckSpawns = {
	[1] = {
		...
		security = {
			...
			[2] = {ped = 's_m_m_security_01', seat = 0, weapon = 'WEAPON_PISTOL'},
