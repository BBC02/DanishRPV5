...
Config.Vehicles = {
    {name = 'nspeedo', label = 'Speedo Express Van', desc = 'Rute inde for byen, giver mindre', pay = 5000, delivery = Config.Deliveries.City}, -- Boxville
    {name = 'nspeedo', label = 'Speedo Express Van', desc = 'Rute ude af byen, giver bedre',  pay = 10000, delivery = Config.Deliveries.State}, -- Speedo
}
...
Config.WorkClothes = {
    ['skin_male'] = {
		...
		torso = {component_id = 11, texture = 0, drawable = 66},
		undershirt = {component_id = 8, texture = 0, drawable = 15},
		pants = {component_id = 4, texture = 0, drawable = 129},
