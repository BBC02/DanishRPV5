stopPassengerShuffle	= false		--	Stop passenger shuffling to driver seat when driver seat is empty
...
exemptKeys				= {21}		--	Left-Shift (hold it down to temporarily allow swapping seats from passenger to driver)
