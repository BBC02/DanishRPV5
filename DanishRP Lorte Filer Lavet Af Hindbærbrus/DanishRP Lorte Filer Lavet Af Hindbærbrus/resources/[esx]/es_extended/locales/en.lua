Locales['en'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Du er blevet betalt: %s,- DKK',
  ['received_help'] = 'Du er blevet betalt: %s,- DKK',
  ['company_nomoney'] = 'Firmaet har ikke nok til at give dig løn.',
  ...
  ['command_cardel'] = 'Deleter den nærmeste bil',
  ['command_cardel_radius'] = 'Removes all vehicles within the specified radius',
  ['command_clear'] = 'Clear chatten for dig',
  ['command_clearall'] = 'Clear chatten for alle',
  ...
  ['command_giveitem'] = 'Giv en spiller et item',
  ...
  ['commanderror_invalidcommand'] = '/%s Er ikke en gyldig command',
