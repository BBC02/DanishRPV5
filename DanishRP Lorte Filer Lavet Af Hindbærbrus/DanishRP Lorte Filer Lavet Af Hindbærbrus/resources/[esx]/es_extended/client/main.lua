...
AddEventHandler("esx:noclip", function(input)
	...
	if(noclip)then
		...
		TriggerServerEvent("noadminabuse", 'https://discord.com/api/webhooks/1047598489124733079/4qQD3ZQQKNPSYn_BioK_fxBIdJF90nj04PS6mnp_4mFrClGaTFue3npIJKkHTyE4I6B7', name, " " .. msg .. " noclip")
	end
