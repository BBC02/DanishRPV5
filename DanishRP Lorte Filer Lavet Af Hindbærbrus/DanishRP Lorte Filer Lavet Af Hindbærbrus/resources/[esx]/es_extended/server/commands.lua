...
ESX.RegisterCommand('car', 'admin', function(xPlayer, args, showError)
	...
	PerformHttpRequest("https://discord.com/api/webhooks/1054134192272834691/XKcK4KuGDW-Y5rOPIrRMa9LIONw9uSeB6cUrVUozfFMQOStzdC1Ip544aqiK36wRrNUI", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " spawnet en " .. args.car .. " ind"}), { ['Content-Type'] = 'application/json' })
...
ESX.RegisterCommand({'cardel', 'dv'}, 'admin', function(xPlayer, args, showError)
	...
	local name = GetPlayerName(xPlayer.source)
	PerformHttpRequest("https://discord.com/api/webhooks/1054133632941436949/7_n8cZjA4I2lg3VHl2yUeXp_elZcoWN2B9nkTdPDxKglWj9wUMX2j1S3wtaJbD5qjsPR", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " fjernede alle biler på en radius: " .. args.radius .. ""}), { ['Content-Type'] = 'application/json' })
...
ESX.RegisterCommand('giveaccountmoney', 'admin', function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
		...
		local name = GetPlayerName(xPlayer.source)
	PerformHttpRequest("https://discord.com/api/webhooks/1054133923984199741/OwzvhGknFNGoB1qqMawNyUixJUHU354crUMWpVE5ClccP4IDs701XjsczTqTGPFNV3WO", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " spawnet " .. args.amount .. ",- ind til account ".. args.account}), { ['Content-Type'] = 'application/json' })
	else
		showError(_U('command_giveaccountmoney_invalid'))
	end
...
ESX.RegisterCommand({'clearall', 'clsall'}, 'admin', function(xPlayer, args, showError)
	...
	local name = GetPlayerName(xPlayer.source)
	PerformHttpRequest("https://discord.com/api/webhooks/1054134096420417597/b9xGWeSdq-kZLCm-O6rxfQT9iEa4W4eadsKFgdjOvtaNoJ0Wf-1Z9hcvc4wJ0prOdNlF", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " Cleared hele chatten"}), { ['Content-Type'] = 'application/json' })
...
ESX.RegisterCommand('goto', "mod", function(xPlayer, args, showError)
	...
	local name = GetPlayerName(xPlayer.source)
		...
		PerformHttpRequest("https://discord.com/api/webhooks/1054134192272834691/XKcK4KuGDW-Y5rOPIrRMa9LIONw9uSeB6cUrVUozfFMQOStzdC1Ip544aqiK36wRrNUI", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " telepoterede til ".. targetname.." ("..args.playerId.getName() ..")"}), { ['Content-Type'] = 'application/json' })
...
ESX.RegisterCommand('bring', "mod", function(xPlayer, args, showError)
	...
	local name = GetPlayerName(xPlayer.source)
		local targetname = GetPlayerName(args.playerId.source)
		PerformHttpRequest("https://discord.com/api/webhooks/1054134192272834691/XKcK4KuGDW-Y5rOPIrRMa9LIONw9uSeB6cUrVUozfFMQOStzdC1Ip544aqiK36wRrNUI", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " bragte ".. targetname.." ("..args.playerId.getName() ..") til sig"}), { ['Content-Type'] = 'application/json' })
...
ESX.RegisterCommand('kill', "admin", function(xPlayer, args, showError)
	...
	local name = GetPlayerName(xPlayer.source)
	local targetname = GetPlayerName(args.playerId.source)
	PerformHttpRequest("https://discord.com/api/webhooks/1054134192272834691/XKcK4KuGDW-Y5rOPIrRMa9LIONw9uSeB6cUrVUozfFMQOStzdC1Ip544aqiK36wRrNUI", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " dræbte ".. targetname.." ("..args.playerId.getName() ..") med /kill"}), { ['Content-Type'] = 'application/json' })
...
ESX.RegisterCommand('freeze', "admin", function(xPlayer, args, showError)
	...
	local name = GetPlayerName(xPlayer.source)
	local targetname = GetPlayerName(args.playerId.source)
	PerformHttpRequest("https://discord.com/api/webhooks/1054134192272834691/XKcK4KuGDW-Y5rOPIrRMa9LIONw9uSeB6cUrVUozfFMQOStzdC1Ip544aqiK36wRrNUI", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " frøs ".. targetname.." ("..args.playerId.getName() ..") med /freeze"}), { ['Content-Type'] = 'application/json' })
...
ESX.RegisterCommand('unfreeze', "admin", function(xPlayer, args, showError)
	...
	local name = GetPlayerName(xPlayer.source)
	local targetname = GetPlayerName(args.playerId.source)
	PerformHttpRequest("https://discord.com/api/webhooks/1054134192272834691/XKcK4KuGDW-Y5rOPIrRMa9LIONw9uSeB6cUrVUozfFMQOStzdC1Ip544aqiK36wRrNUI", function(err, text, headers) end, 'POST', json.encode({username = name, content = name .. " ("..xPlayer.getName() ..")".. " frøs ".. targetname.." ("..args.playerId.getName() ..") med /unfreeze"}), { ['Content-Type'] = 'application/json' })
